    ...
    >
      ...
      >
        <section id="educate-users">
          ...
          <Button
            variant="contained"
            sx={{ textTransform: "none", margin: "10px auto", width: "80%" }}
      ...
      >
        <section id="free-trial" style={{}}>
          <Typography variant="h4" textAlign="center" gutterBottom>
            How Nest 8 works for <br></br>
            <em>your</em> business type
          </Typography>
          <Typography
            variant="h6"
            textAlign="center"
          ...
          >
              ...
              >
                ...
                <CardContent>
                  <Typography variant="body1" textAlign="center" gutterBottom>
                    Farmers: Improve efficiency of your operations, assess your
                    business health, identify growth opportunities.
                  </Typography>
                </CardContent>
              </Box>
            </Card>
            <Card elevation={10} sx={{ maxWidth: 600 }}>
              ...
              >
                ...
                <CardContent>
                  <Typography variant="body1" textAlign="center" gutterBottom>
                    Non-profits: Assess how effective your fundraising efforts
                    are compared to other non-profits.
                  </Typography>
                </CardContent>
              </Box>
            </Card>
          ...
          <Box sx={{ display: "flex", justifyContent: "flex-end" }}>
            <Button
              variant="outlined"
              sx={{ mt: 5, mr: 2, alignSelf: "flex-end" }}
              onClick={() => handleClick("/product_page")}
            >
              Sign up for free
            </Button>
          ...
          <Box sx={{ border: 0.1, p: 2, width: "60%", my: 3, mx: "auto" }}>
            ...
            <List sx={{ ml: 6, listStyleType: "disc" }}>
              <ListItem sx={{ display: "list-item" }}>
                Access all N8 features
              </ListItem>
              <ListItem sx={{ display: "list-item" }}>Input your data</ListItem>
              <ListItem sx={{ display: "list-item" }}>
                24/7 online support
              </ListItem>
              <ListItem sx={{ display: "list-item" }}>Cancel anytime</ListItem>
            </List>
          </Box>
          <Button
            variant="contained"
        ...
        <section id="links">
          ...
          <Grid item style={{ marginTop: "70px", marginBottom: "1px" }}>
            <Typography variant="h7">
              @ 2024 Nest8. All rights reserved. 'Nest8' is a trademark of Nest8
              LLC
            </Typography>
          </Grid>
