...
function MyData() {
  ...
  const uncompletedRecommendationsToDisplay = useSelector(
                     ...
                     secondary={
                      ...
                      primary={
                        <Link
                          href="#"
                          onClick={(e) =>
                            handleMissingLinkClick(e, date[0], date[2])
                          }
                          sx={{
                            cursor: "pointer",
                            "&:hover": {
                        ...
                        >
                          <Typography
                            ...
                            color="error"
                          >
                            You are missing monthly inputs for {date[1]}{" "}
                            {date[0]}
                          </Typography>
                        </Link>
                      }
                    ...
                    <ListItemText
                      ...
                      secondary={
                        <Link
                          href="#"
                          onClick={(e) =>
                            handleUncompletedRecsLinkClick(e, date[0], date[2])
                          }
                          sx={{
                            cursor: "pointer",
                            "&:hover": {
